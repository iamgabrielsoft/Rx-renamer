...
use clap::{SubCommand, Arg, AppSettings, App};
...
pub fn create_app<'a>() -> App<'a,'a> {
    ...
    App::new(crate_name!())
        ...
        .subcommand(
            SubCommand::with_name(TO_ASCII_SUBCOMMMAND)
                .args(&common_args)
                .args(&path_args)
...
//conver the arguement to an integer -> Result || integer
fn is_integer(arg: String) -> Result<(), String>{
...
/* a borrowed reference to the OS string  */
